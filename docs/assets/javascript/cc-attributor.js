...
function ChangeStatusMessage() {
	var funnymessages = ['Being inspired by Mark Otter', 'Championing open education with Lorna Campbell',   'Favoriting all the tweets by Robin DeRosa', 'Taking cricket lessons from Rajiv Jhangiani', 'Buying at least 3 paintings by Sheila MacNeill', 'Getting Air (and GIFing it) with Terry Greene', 'Admiring the castle view of @ammienoot', 'Humbly thanking Robert Daniel', 'Gone curling with Clint Lalonde', 'Dreaming of walking the Flaggy Shore with Catherine Cronin', 'High fiving with Hugh Blackmer', 'Jamming in the studio with Irwin Devries', 'Getting inpsired by economics listening to Jim Luke', 'Sending profuse thanks to Jim McGee', 'Checking our spelling of Autumm Caines', 'Peeking in  Barbara Ganley\'s garden', 'Greasing the tubes for transmission', 'Making a GIF with a hard G', 'Smiling at you for being a good attributor', 'Saying thanks to @SenorG for spreading the good word', 'Snickering at the people who keep saying flickr is dead', 'Hoping the SmugMug dudes are keeping the lights on',  'Feeding the squirrels who spin the turbines', 'Checking the weather for stormy clouds', 'Waving at Ken Bauer', 'Bueller? Bueller?', 'Spreading smooth peanut butter', 'Barking like a big dog', 'Has anyone seen my data? Jason?', 'Wondering about the meaning of life', 'Wishing Brian Lamb would blog more', 'Wondering if Jim Groom really exists', 'Knocking on the doors of the Emerald Castle saying please give us some API data', 'Crosswiring the figwitz circuit', 'Gazing up at the sky', 'Getting the lovely stuff', 'Sautéing onions and garlic in butter', 'Being cool in school like @bennettscience', 'Charging the flux capacitor', 'Asking Scotty for more dilithium crystals', 'Engaging the Serendipity Happenstancer', 'Tossing frisbees', 'Making the donuts', 'Plugging in the Marshall amps and cranking the volume past 11', 'Pondering our measly existence', 'Asking Alexa for help',  'Double clutching and pushing the pedal to the floor', 'Checking our stock options', 'Whistling for Felix' ];
